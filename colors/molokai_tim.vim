...
" Tim Martin: Edited for my personal taste.
...
if &t_Co > 255
   if s:molokai_original == 1
      ...
      hi CursorLineNr ctermfg=208  term=bold     cterm=bold
   endif
   ...
   hi DiffChange      ctermfg=181 ctermbg=NONE
   ...
   hi LineNr          term=bold   ctermfg=239 ctermbg=NONE cterm=NONE
